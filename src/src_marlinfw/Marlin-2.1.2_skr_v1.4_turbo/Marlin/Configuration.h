...
#define STRING_CONFIG_H_AUTHOR "Atomicchess SKR" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 70, 70, 70, 10000 }
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL_PIN                NEOPIXEL_PIN //4 // LED driving pin
