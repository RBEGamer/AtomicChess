...
public:
    ...
    CALIBRATIONSCREEN_H1POS = 40,
    CALIBRATIONSCREEN_A8POS = 41,
    CALIBRATIONSCREEN_SAVE = 42,
    CALIBRATIONSCREEN_MVUP = 43,
    CALIBRATIONSCREEN_MVDOWN = 44,
    CALIBRATIONSCREEN_MVLEFT = 45,
    CALIBRATIONSCREEN_MVRIGHT = 46,
    ...
    QT_UI_SET_ORIENTATION_0 = 57,
    QT_UI_SET_ORIENTATION_180 = 58
};
