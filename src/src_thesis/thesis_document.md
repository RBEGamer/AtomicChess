...
![MOCKUP_MAIN_MENU](./images/ATC_Calibration_Guide.png)

### Chess Piece Movement Algorithm

![MOCKUP_MAIN_MENU](./images/ATC_ChessMoveAlgorithm.png)
...
![MOCKUP_MAIN_MENU](./images/FigureMovementTims_GRAPH_COMP.PNG)
