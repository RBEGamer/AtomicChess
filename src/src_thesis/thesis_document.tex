...
ist ein kompfortables Spiel auch gegen sich selber möglich, da das
Überlegen und Ausführen von Spielzügen der Gegenseite entfällt. Dem
Spieler wird zudem die Möglichkeit geboten, gegen andere Spieler an
diversen Orten oder gegen eine Schachlogik zu spielen und so Züge
auszuführen, die jener im besten Fall nicht einmal vorhergesehen hat.
Zudem wird die Korrektheit der getätigten Züge überprüft und sämtliche
traditionellen Spielregeln in das Spiel mit einbezogen. Somit ist es
nicht nur möglich, dass Anfänger das Spiel erlernen können, sondern auch
bewährten Spielern mit unerwarteten Zügen des virtuellen oder realen
Gegners neue Methodiken darzustellen.
...
\textbackslash{}begin\{sidewaystable\} \centering

\textbackslash{}resizebox\{\linewidth\}\{!\}\{\%
...
Die Abmessungen (Außenmaße) der autonomen Schachtische unterscheiden
...
\textless{}! --- PRO CONS EMBEDDED SYSTEM --\textgreater{}

Hier wurde ein \passthrough{\lstinline!Raspberry Pi 3b+!} gewählt, da
dieser kostengünstig und zugleich einfach beschaffbar ist. Zudem sind
alle wichtigen Schnittstellen zur späteren Verwendung herausgeführt,
welches diesen zu einen idealen System zur Prototypen-Entwicklung macht.
