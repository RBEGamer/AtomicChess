...
\begin{longtable}[]{@{}llll@{}}
\caption{MoveValidator-Service API Overview}\tabularnewline
\toprule
AtomicChess Move-Validator Service API & API-Route & Method &
...
Allgemein geschieht die Kommunikation über vier API Calls, welche vom
MoveValidator-Service angeboten werden. Als erstes wird vom Backend der
\passthrough{\lstinline!/rest/init\_board!} Request verwendet, welcher
ein Spielbrett in der \gls{fen} Notation zurückgibt. Allgemein arbeitet
wurde das komplette System so umgesetzt, dass dieses mit einem Spielfeld
in einer Zeichenketten/String arbeitet. Dies hat den Vorteil, dass die
...
\begin{longtable}[]{@{}ll@{}}
\caption{Vergleich FEN - X-FEN}\tabularnewline
\toprule
...
rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R\strut
\end{minipage} & \begin{minipage}[t]{0.52\columnwidth}\raggedright
rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
