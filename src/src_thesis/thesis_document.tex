...
Logik. Daraus resultieren einfacherer und auch Ressourcen-sparendere
...
grünster zusammengesetzt und Fehlerquellen schneller entdeckt und
...
Datenbanken und Webtechnologien und Softwarenentwicklung. Zudem wird
...
\section{Grundlegende Verifikation der ausgewählten
...
\gls{nfc}-Lese/Schreibgerät mit Daten verschiedenster Art beschrieben
...
\section{Erstellung des zweiter
...
\subsection{Fazit bezüglich des finalen
...
\subsection{Vorüberlegungen}\label{voruxfcberlegungen}}
...
\subsection{MoveValidator}\label{movevalidator}}
...
\subsection{AutoPlayer}\label{autoplayer}}
