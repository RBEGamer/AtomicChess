...
Schachtisch anbietet, hat der Nutzer kaum auswahlmöglichkeiten auf der
kommerziellen Seite.
...
auch kleine und preisgünstige Steuerungen \ref{3dmarlinctl} erhältlich,
welche 2-3 Schrittmotoren und diverse zusätzliche Hardware ansteuern
können.
...
deren \gls{usb}-Vendor und Product-ID angelegt.
