...
\caption{Erster Prototyp des autonomen Schachtisch}
\end{figure}
...
\caption{Tool zur Erstellung des NDEF Payloads:
...
\caption{Finaler autonomer Schachtisch}
\end{figure}

\hypertarget{uxe4nderungen-der-mechanik}{%
\section{Änderungen der Mechanik}\label{uxe4nderungen-der-mechanik}}
...
\caption{Login-Requst und Response}
\end{figure}
