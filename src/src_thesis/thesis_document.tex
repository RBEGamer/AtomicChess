...
\tightlist
\item
  vllt kann man sagen dass die meisten Teile im Makerspace der FH
  erstellt wurden
\item
  was ist vorhanden ?
\end{itemize}
...
\item
  lautstärke
\item
  vorerfahrnung in cad ed druck und schaltungsdesign =\textgreater{}
  somit kein Problem
\end{itemize}
...
\item
  reicheweiten test mit 22mm =\textgreater{} kleinster gefundener
  folienbasierender NFC Tag
\item
...
\tightlist
\item
  warum =\textgreater{} einfache ansteuerung, keine zusätzlichen encoder
  notwendig, da mit keinem Schrittverlust zu rechnen ist
\item
