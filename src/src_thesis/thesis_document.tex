...
Schachbrettern abdecken und lediglich das bewegen der Schachfiguren
fehlt. Die DGT Bretter können die Position der Figuren erkennen und
ermöglichen so auch Spiele über das Internet bzw. können diese auch
Spiele als Livestream anbieten. Diese werden bei Schachtunieren für die
Übertragung der Partien sowie die Aufzeichnung der Spielzüge verwendet
und bieten support für den anschluss von weiterer Peripherie wie z.B.
Schachuhren.

Somit gibt es zum Zeitpunkt der Recherche nur einen Hersteller von
autonomen Schachbrettern.
...
die DIN 9241\cite{din9241} beschrieben. Hierbei geht es primär um
