...
\newacronym{xfen}{X-FEN}{Extended Forsyth-Edwards-Notation}
...
\newacronym{udev}{UDEV}{userspace device file system}
\newacronym{hf}{HF}{high frequency}
\newacronym{uscf}{USCF}{United States Chess Federation}
