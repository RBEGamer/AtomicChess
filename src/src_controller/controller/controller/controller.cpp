...
int main(int argc, char *argv[]) {
    ...
    std::string ALTERNATIVE_BACKEND_URL[] = {
            ConfigParser::getInstance()->get(ConfigParser::CFG_ENTRY::NETWORK_BACKEND_URL), automatic_discovered_server_ip, "http://127.0.0.1:9999", "http://127.0.0.1:3000", "http://127.0.0.1"};
