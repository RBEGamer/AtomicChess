...
int main(int argc, char *argv[])
{
    ...
    std::string ALTERNATIVE_BACKEND_URL[] = {ConfigParser::getInstance()->get(ConfigParser::CFG_ENTRY::NETWORK_BACKEND_URL), "http://atomicchess.de", "http://atomicchess.de:3000"};
