...
public:
	...
	enum class CFG_ENTRY
	{
		...
		NETWORK_ENABLE_UDP_DISCOVERABLE= 2,
		NETWORK_UDP_DISCOVERABLE_USER_DATA=3,

		NETWORK_UDP_DISCOVER_ATC_SERVER_ENABLE=4,
		NETWORK_UDP_DISCOVER_ATC_SERVER_USER_DATA_EXPECTED=5,
		NETWORK_UDP_DISCOVER_ATC_SERVER_PORT = 6,
		...
		MECHANIC_CHESS_FIELD_WIDTH_X = 26,
        MECHANIC_CHESS_FIELD_WIDTH_Y = 27,
        ...
        //SET FEEDRATE IS NOT SUPPORTED ON DK HARDWARE
		MECHANIC_FEEDRATE_TRAVEL = 39, //MOVE SPEED IN MM/MINUTE FOR TRAVEL WITH NO CHESS FIGURE
		MECHANIC_FEEDRATE_MOVE = 40, //MOVE SPEED IN MM/MINUTE FOR TRAVEL WITH MAGNET ACTIVATED AND FIGURE ATTACHED
        MECHANIC_FEEDRATE_SIWTHC_XY_AXIS = 41, // SWITCHES THE X Y AXIS MAINLY USED FOR MARLIN BUT ALSO AVAIABLE FOR THE DK VERSION
		...
		HARDWARE_MARLIN_SERVO_COIL_A_INDEX = 63, //MARLIN SERVO INDEX STARTING FROM 0
		HARDWARE_MARLIN_SERVO_COIL_B_INDEX = 64, //MARLIN SERVO INDEX STARTING FROM 0
		HARDWARE_MARLIN_SERVO_COIL_BOTTOM_POS = 65, //SERVO POSITION MAGNET DOWN 0-255
		HARDWARE_MARLIN_SERVO_COIL_UPPER_POS = 66, //SERVO POSITION MAGNET DOWN 0-255
		HARDWARE_MARLIN_RESET_EEPROM_TO_DEFAULT_DURING_STARTUP = 67, // RESETS THE
        HARDWARE_MARLIN_RGBW_STRIP_SWITCH_GB = 68, //SWITCHES FOR RGBW STRIP THE BLUE AND GREEN COMPONENT
        HARDWARE_MARLIN_COOLING_FAN_DRIVER_INDEX = 69,


        HARDWARE_UBC_SERIAL_BAUD = 80, //SERIAL BUAD RATE FOR THE USERBOARD CONTROLLER (NFC READER FOR HWREV 1/2)
        HARDWARE_UBC_SERIAL_PORT = 81, //SERIAL PORT RATE FOR THE USERBOARD CONTROLLER (NFC READER FOR HWREV 1/2)
        HARDWARE_UBC_NFC_READ_RETRY_COUNT = 82, //RETRY X TIMES AFTER AN INVALID NFC READ

        HARDWARE_QTUI_FLIP_ORIENTATION = 83, //FLIP QT SCREEN 180 DEGREE OR 0 DEGREE
        ...
        USER_RESERVED_MAKE_MOVE_MANUAL_TEST_DO_SYNC = 104, // IF A MOVE WAS MADE WITH THE MAKE MOVE DEBUG MENU A SYNC BOARD WILL BE EXECUTED ALSO
        USER_RESERVED_SKIP_USER_NFC_MOVE_SEARCH_AFTER_FIRST_CHANGE = 105,
        USER_RESERVED_AUTO_SCAN_BOARD_TIME_IF_USERS_TURN = 106, //AUTOSCAN BOARD AFTER x SECOND -1 TO DISABLE
        USER_RESERVED_EXTENTION_VOICE_RECOGNITION_ENABLED= 107, //ENABLE THE ALEXA VOICE SERVICE USING THE ATC SERVERS
        USER_RESERVED_EXTENTION_VOICE_RECOGNITION_URL = 108,
        USER_RESERVED_EXTENTION_DGT3000_INTERFACE_ENABLED = 109,
