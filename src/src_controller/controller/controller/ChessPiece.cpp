...
ChessPiece::FIGURE ChessPiece::getFigureByName(std::string _name, ChessPiece::COLOR _color) {
    ChessPiece::FIGURE tmp;

    tmp.is_empty = false;
    tmp.color = ChessPiece::COLOR::COLOR_UNKNOWN;
    tmp.type = ChessPiece::TYPE::TYPE_INVALID;
    tmp.figure_number = -1;
    ...
    //IF ONLY ONE CHARATER WE CAN USE THE ALREDY EXISING FUNCITON
    if(_name.length() == 1){
        return getFigureByCharakter(_name[0]);
    }
    ...
    if(_name == "pawn"){tmp.type = ChessPiece::TYPE::TYPE_PAWN;}
    else if(_name == "rook" || _name == "castle"){tmp.type = ChessPiece::TYPE::TYPE_ROOK;}
    else if(_name == "knight"){tmp.type = ChessPiece::TYPE::TYPE_KNIGHT;}
    else if(_name == "bishop"){tmp.type = ChessPiece::TYPE::TYPE_BISHOP;}
    else if(_name == "queen"){tmp.type = ChessPiece::TYPE::TYPE_QUEEN;}
    else if(_name == "king"){tmp.type = ChessPiece::TYPE::TYPE_KING;}


    //APPLY COLOR
    if(tmp.type != ChessPiece::TYPE::TYPE_INVALID){
        tmp.color = _color;
    }
...
ChessPiece::FIGURE ChessPiece::getFigureByCharakter(char _figure_rep) {
    ...
    switch (_figure_rep) {
        ...
        case 'r':
            tmp.color = ChessPiece::COLOR_BLACK, tmp.type = ChessPiece::TYPE_ROOK;
            break;
        case 'n':
            tmp.color = ChessPiece::COLOR_BLACK, tmp.type = ChessPiece::TYPE_KNIGHT;
            break;
        case 'b':
            tmp.color = ChessPiece::COLOR_BLACK, tmp.type = ChessPiece::TYPE_BISHOP;
            break;
        case 'q':
            tmp.color = ChessPiece::COLOR_BLACK, tmp.type = ChessPiece::TYPE_QUEEN;
            break;
        case 'k':
            tmp.color = ChessPiece::COLOR_BLACK, tmp.type = ChessPiece::TYPE_KING;
            break;
        case 'p':
            tmp.color = ChessPiece::COLOR_BLACK, tmp.type = ChessPiece::TYPE_PAWN;
            break;
        case 'R':
            tmp.color = ChessPiece::COLOR_WHITE, tmp.type = ChessPiece::TYPE_ROOK;
            break;
        case 'N':
            tmp.color = ChessPiece::COLOR_WHITE, tmp.type = ChessPiece::TYPE_KNIGHT;
            break;
        case 'B':
            tmp.color = ChessPiece::COLOR_WHITE, tmp.type = ChessPiece::TYPE_BISHOP;
            break;
        case 'Q':
            tmp.color = ChessPiece::COLOR_WHITE, tmp.type = ChessPiece::TYPE_QUEEN;
            break;
        case 'K':
            tmp.color = ChessPiece::COLOR_WHITE, tmp.type = ChessPiece::TYPE_KING;
            break;
        case 'P':
            tmp.color = ChessPiece::COLOR_WHITE, tmp.type = ChessPiece::TYPE_PAWN;
            break;


        default:
            tmp.color = ChessPiece::COLOR_UNKNOWN, tmp.type = ChessPiece::TYPE_INVALID;
            break;
