...
#ifdef USES_QT
#define WEBSERVER_STAUTS_PORT 8200
#define WEBSERVER_WEBQT_STATUS_PORT 8202
#define EVENT_CLIENT_PORT L"8201" // 1
#define EVENT_URL_COMPLETE "http://127.0.0.1:8201" //1
#else
#define WEBSERVER_STAUTS_PORT 8201 //1
#define EVENT_CLIENT_PORT L"8200"
#define EVENT_CLIENT_PORT_WEBGL L"8202"
#define EVENT_URL_COMPLETE "http://127.0.0.1:8200"
#define EVENT_URL_COMPLETE_WEBGL "http://127.0.0.1:8202"
#endif

#define EVENT_URL_SETEVENT "/processevent"
#define EVENT_URL_VERSION "/gcversion"
...
public:
    ...
    GAMESCREEN_ABORT_GAME = 32,
    GAMESCREEN_PLAYER_COLOR = 33,
    GAMESCREEN_POSSIBLE_MOVES = 34,
    GAMESCREEN_PLAYER_TURN_COLOR = 35,
    ...
    PLAYER_EMM_RESET = 38,
    PLAYER_EMM_INPUT = 39,
    PLAYER_EMM_INPUT_RAW = 40,

    QT_UI_RESET = 41,

    CALIBRATIONSCREEN_H1POS = 42,
    CALIBRATIONSCREEN_A8POS = 43,
    CALIBRATIONSCREEN_SAVE = 44,
    CALIBRATIONSCREEN_MVUP = 45,
    CALIBRATIONSCREEN_MVDOWN = 46,
    CALIBRATIONSCREEN_MVLEFT = 47,
    CALIBRATIONSCREEN_MVRIGHT = 48,

    //TODO ADD FOR PARKPOS INNER AUTHER
    CALIBRATIONSCREEN_PPWHITE1 = 49,
    CALIBRATIONSCREEN_PPBLACK1 = 50,
    CALIBRATIONSCREEN_PPBLACK16 = 51,
    PLAYER_EMM_SCAN_BOARD = 52,

    SOLANOIDSCREEN_BOTTOM_POS = 53,
    SOLANOIDSCREEN_UPPER_POS = 54,
    SOLANOIDSCREEN_SAVE = 55,
    SOLANOIDSCREEN_MVDONW = 56,
    SOLANOIDSCREEN_MVUP = 57,
    

    BEGIN_BTN_DEFAULT = 58,


    QT_UI_SET_ORIENTATION_0 = 59,
